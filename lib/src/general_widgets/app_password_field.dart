...
class AppPasswordField extends StatefulWidget {
  const AppPasswordField({
    ...
    this.width,
    this.labelSpace = 8,
    this.padding = const SizedBox(height: 16),
    this.onTap,
    this.decoration,
    this.hintStyle,
...
class _AppPasswordFieldState extends State<AppPasswordField> {
  ...
  void initState() {
    super.initState();
    _borderSide = widget.borderSide ?? BorderSide(color: AppColors.neutral50);
  }
          ...
          decoration:
              ...
              InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(widget.borderRadius),
                  borderSide: BorderSide(color: AppColors.primary300, width: 1),
                ),
              ),
        ),
